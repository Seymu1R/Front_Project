...
//           <div class="col-xl-4  product-items">
//                     <span class="span-id" hidden >${item.id}</span>
//                     <img  class="img-products" src="${item.image}" alt="">
//                     <a id="product-title" href="">${item.title}</a>
//                     <p>US $ <span id="product-price" >${item.price}</span>  <span>|</span><span>{ 4% off }</span></p>
//                     <div class="hover-detail">
//                       <div class="top"><svg class="svgEye" height="20" width="20" viewBox="0 0 32 32"
//                           xmlns="http://www.w3.org/2000/svg">
...
//         if (a < 9) {
//           z += `
//           <div id="hover-div" class="col-xl-3">
//               <div class="row">
//                 <div class="col-xl-6">
...
//         document.querySelector("#salam-222").innerHTML=j;
//         document.querySelector("#futured-products-2").innerHTML = z;
//         document.querySelector("#index-product-1").innerHTML = x;
//         document.querySelector("#DEALS-OF-THE-DAY").innerHTML = y;
